...
const BetterCheckbox: NextPage<Props> = ({ setIsChecked, isChecked }) => {
  return (
    <div className="flex flex-row text-primary-text items-center font-fira-mono space-x-5">
      <label
        className="mt-px font-light text-primary-text cursor-pointer select-none"
        htmlFor="check"
      >
        Remember Me
      </label>
      ...
      border-blue-gray-200 transition-all before:absolute before:top-2/4 before:left-2/4 before:block before:h-12 before:w-12
